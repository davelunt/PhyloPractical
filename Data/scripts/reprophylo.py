...
##############################################################################################
    ...
    def __init__(self, loci):
        ...
        self.defaults = {'raxmlHPC': programspath+'raxmlHPC_820_64.exe',
                         'mafft': programspath+'mafft-win\\mafft',
                         'muscle': programspath+'muscle',
                         'trimal': programspath+'trimAl\\bin\\trimal.exe',
                         'pb': programspath+'pb',
    ...
    def propagate_metadata():
        for t in self.trees.keys():
            for l in self.trees[t][0]:
                ...
                record_id = feature_id.rpartition()[0]
                record = [r for r in pj.records if r.id == record_id][0]
